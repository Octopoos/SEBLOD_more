...
<div class="seblod">
    ...
    <ul class="adminformlist adminformlist-2cols">
        <?php
		echo JCckDev::renderForm( 'core_menuitem', @$options2['itemid'], $config, array( 'label'=>'Redirection', 'options'=>'Inherited=-1', 'selectlabel'=>'None', 'storage_field'=>'json[options2][itemid]' ) );
