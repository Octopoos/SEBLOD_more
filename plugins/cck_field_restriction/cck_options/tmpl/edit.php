...
<div class="seblod">
    ...
    <ul class="adminformlist adminformlist-2cols">
		...
		echo '<li class="w100"><label>'.JText::_( 'COM_CCK_OPTION_VALUES' ).'</label>'
		 .	 JCckDev::getForm( 'core_dev_select', '', $config, array( 'label'=>'', 'defaultvalue'=>'cck', 'selectlabel'=>'', 'options'=>'SEBLOD=cck||SEBLOD eCommerce=cck_ecommerce||', 'storage_field'=>'trigger_target' ) )
